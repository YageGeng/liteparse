...
pub struct ParsedPage {
    ...
    pub text: String,
    pub text_items: Vec<TextItem>,
    /// Optional external layout detections assigned after projection.
    ///
    /// Kept outside the markdown layout internals so YOLO can improve JSON,
    /// text ordering, and annotated screenshots without forking upstream's
    /// rule-based markdown pipeline.
